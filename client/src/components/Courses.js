...
export default class Courses extends Component {
    ...
    render(){
        ...
        return(
            <div className="bounds">
                {courses}
                <div className="grid-33"><Link className="course--module course--add--module" to={{pathname: "/courses/create", state: {from: location}}}>
    ...
    coursesTemplate = (course) => {
        const {location} = this.props;
        return(
            <div key={course.id.toString()} className="grid-33"><Link className="course--module course--link" to={{pathname: "/courses/" + course.id, state: {from: location}}}>
